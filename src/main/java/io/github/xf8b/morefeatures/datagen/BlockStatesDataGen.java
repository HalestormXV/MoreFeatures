    ...
    protected void registerStatesAndModels() {
        MoreFeaturesRegistries.BLOCKS.getEntries()
                ...
                .forEach(block -> {
                    ...
                    if (block instanceof DoorBlock) {
                    ...
                    } else if (block instanceof BushBlock && !(block instanceof CropsBlock)) {
                        ...
                        for (AttachFace face : WoodButtonBlock.FACE.getAllowedValues()) {
                            for (Direction facing : WoodButtonBlock.HORIZONTAL_FACING.getAllowedValues()) {
                                for (Boolean powered : WoodButtonBlock.POWERED.getAllowedValues()) {
                                    int xRotation;
                                    int yRotation;
                                    ...
                                    getVariantBuilder(block)
                                            ...
                                            .with(WoodButtonBlock.HORIZONTAL_FACING, facing)
                        ...
                        for (int age : CropsBlock.AGE.getAllowedValues()) {
