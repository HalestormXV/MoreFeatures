            ...
            MoreFeaturesRegistries.ENCHANTMENTS.getEntries()
                    ...
                    .forEach(enchantment -> {
                        if (enchantment.isCurse()) {
                            this.add(enchantment, "Curse of " + WordUtils.capitalizeFully(enchantment.getName().replace("enchantment." + MoreFeatures.MOD_ID + ".", "").replace("_", " ").replace(" curse", "")));
                        } else {
                            this.add(enchantment, WordUtils.capitalizeFully(enchantment.getName().replace("enchantment." + MoreFeatures.MOD_ID + ".", "").replace("_", " ")));
                        }
                    });
