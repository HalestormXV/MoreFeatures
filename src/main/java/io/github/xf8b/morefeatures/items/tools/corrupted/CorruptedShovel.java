...
public class CorruptedShovel extends ShovelItem {
    ...
    public void appendTooltip(ItemStack stack, World worldIn, List<Text> tooltip, TooltipContext flagIn) {
        if (KeyboardChecker.isHoldingShift()) {
            ...
            tooltip.add(new LiteralText("The attack damage and speed will be random."));
            tooltip.add(new LiteralText("Good luck, and pray to the RNG gods."));
        } else {
