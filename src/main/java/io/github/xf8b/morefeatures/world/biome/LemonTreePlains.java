package io.github.xf8b.morefeatures.world.biome;
...
public class LemonTreePlains extends Biome {
    public LemonTreePlains() {
        ...
        ConfiguredDecorator lemonTreeConfig = Decorator.COUNT_EXTRA_HEIGHTMAP.
                configure(new CountExtraChanceDecoratorConfig(6, 0.1F, 1));
        this.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, Feature.NORMAL_TREE
